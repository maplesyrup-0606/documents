...
public:
    ...
    /**
     * recursive helper function for the above prune function
    */
    void prune(Node* node, const int tol);
...
private:
    ...
    int idealPrune(const int leaves, const int low, const int high) const;
    /**
     * Helper recursive fuction for clear;
    */
    ...
    /**
     * Support recursive fucntion for copy
    */
    void copySupport(Node *  before, Node * orig);

    void pruneSize(Node * node , const int tol, vector<Node*> * leaf) const;
    /**
    ...
    // void idealPrune(vector<Node *> leafs, int max, int min) const;
    int countPrunedLeaves(vector<Node *> leafs, int tol) const;
